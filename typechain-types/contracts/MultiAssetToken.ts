...
export interface MultiAssetTokenInterface extends utils.Interface {
  functions: {
...
export interface MultiAssetToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiAssetTokenInterface;
